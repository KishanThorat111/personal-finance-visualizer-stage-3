...
// import BudgetChart from '@/components/BudgetChart'; // ✅ New import
...
//       setBudgets(budgetJson); // ✅ Store budgets
//     } catch (err) {
//       setError(true);
...
//             <BudgetChart budgets={budgets} transactions={transactions} /> {/* ✅ Budget vs Actual */}
        ...
        <>
          ...
          >
            ...
            <BudgetChart 
              ...
              onBudgetChangeSuccess={fetchData} 
